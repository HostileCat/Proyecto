        ...
        <main class="main">
            <section class="main__section">
                <h1 class="section__title">Editar Plato</h1>
                    <form action="/proRest/administracionPlato?accion=editarSubmit" method="post" enctype="multipart/form-data" id="dishForm" class="section__form section__form--dish">
