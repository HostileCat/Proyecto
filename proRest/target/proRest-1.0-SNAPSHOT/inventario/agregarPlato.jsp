<%-- 
    Document   : añadirPlato
    Created on : 20 jun 2024, 16:10:30
    Author     : Propietario
--%>
...
<html>
  ...
  <main class="main">
    <div class="main__menu" id="main__menu">
      ...
      <section class="main__selectCategory" id="main__selectCategory">
        <ul class="main__list">
          ...
          <a href="añadirCategoria.html">
            <li class="main__item">Añadir</li>
          </a>
          <a href="">
            <li class="main__item">Eliminar</li>
          </a>
          <a href="">
            <li class="main__item">Editar</li>
          </a>
    ...
    <section class="main__section">
      ...
      <form action="${pageContext.request.contextPath}/guardarPlato" method="post" enctype="multipart/form-data" class="section__form">
        <div class="section__add addDish">
          <input type="text" placeholder="Nombre" class="add__input" name="nombrePlato" required>
                    ...
                    <% 
                        ...
                        if (categorias != null) {
                            for (model.categoria.Categoria categoria : categorias) {
                                out.println("<option value=\"" + categoria.getId() + "\">" + categoria.getNombreCategoria() + "</option>");
                            }
                        } else {
          ...
          <input type="text" placeholder="Descripción" class="add__input" name="descripcionPlato">
          <input type="text" placeholder="Precio" class="add__input" name="precioPlato">
          <input type="file" accept="image/*" class="addDish__img" name="imagenPlato">
        </div>
