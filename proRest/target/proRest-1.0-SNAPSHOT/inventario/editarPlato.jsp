<%-- 
    ...
    Created on : 20 jun 2024, 16:10:54
    Author     : Propietario
--%>
    ...
    <section class="main__section">
      ...
      <div class="edit__container">
        <div class="edit__content">
          <h1 class="category__title">Platos Principales</h1>
          <ul class="edit__list">
            <a class="edit__item" href="paginaEdicionCategoria.html">
              <li>Nombre del plato</li>
            </a>
            <li class="edit__item">Nombre del plato</li>
            <li class="edit__item">Nombre del plato</li>
            <li class="edit__item">Nombre del plato</li>
            <li class="edit__item">Nombre del plato</li>
            <li class="edit__item">Nombre del plato</li>
